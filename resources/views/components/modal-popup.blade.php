        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-barcode">
                    <ul>
                        <li>
                            <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/barcode1.png')}}"
                                                               alt="img"></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);"><img src="{{ URL::asset('/assets/img/barcode1.png')}}"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-print"><img src="{{ URL::asset('/assets/img/icons/printer.svg')}}"
                                                                 alt="img">Print
                </button>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <select class="form-control form-white select" data-placeholder="Choose a color..."
                                    name="category-color">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="btn btn-closes"><img
                                        src="{{ URL::asset('/assets/img/icons/close-circle.svg')}}" alt="img"></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="btn btn-reverse"><img
                                        src="{{ URL::asset('/assets/img/icons/reverse.svg')}}" alt="img"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="search-set">
                                        <div class="search-input">
                                            <a class="btn btn-searchset"><img
                                                    src="{{ URL::asset('/assets/img/icons/search-white.svg')}}"
                                                    alt="img"></a>
                                        </div>
                                    </div>
                                    <div class="wordset">
                                        <ul>
                                            <li>
                                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="pdf"><img
                                                        src="{{ URL::asset('/assets/img/icons/pdf.svg')}}"
                                                        alt="img"></a>
                                            </li>
                                            <li>
